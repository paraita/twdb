 ...
 *
 */
public class RecupereInfosVilleByName extends TwdbModeleServlet {
	
	private static final long serialVersionUID = 1L;
	
	public RecupereInfosVilleByName() {
		super();
	...
	protected void processRequete(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			if (param != null) {
				URL url = new URL(getServletContext().getInitParameter("urlbdd") + "rechercheVille.xqy?param=" + param);
