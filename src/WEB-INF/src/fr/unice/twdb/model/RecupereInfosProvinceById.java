...
/**
 * This servlet query a province from the database by its id
 * 
 * @author Paraita Wohler
 *
 */
public class RecupereInfosProvinceById extends TwdbModeleServlet {

	private static final long serialVersionUID = 1L;
	
	public RecupereInfosProvinceById() {
		super();
	...
	protected void processRequete(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			if (param != null) {
				URL url = new URL(getServletContext().getInitParameter("urlbdd") + "getprovinceinfobyid.xqy?param=" + param);
