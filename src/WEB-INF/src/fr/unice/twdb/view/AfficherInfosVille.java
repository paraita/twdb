 ...
 *
 */
public class AfficherInfosVille extends HttpServlet {
	...
	private void processRequest(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		if (xml.length() == 0) {
			...
			if((Boolean) req.getAttribute("xml")) {
				...
				String html = XSLTUtils.xml2html(xml, getServletContext().getRealPath("/WEB-INF/classes/fr/unice/twdb/view/xslt/AfficherInfosVille.xsl").toString());
				out.print(html);
			}
		}
	}
